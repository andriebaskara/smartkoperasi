...
@section('content')
    ...
    @include('admin.master.jenis_pembayaran.modal')
@stop
...
@section('js') 
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Jenis Pembayaran");
            $('#pesan').html("");
            $('#deskripsi').val("");
        ...
        function EditData(id, deskripsi){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Jenis Pembayaran");
        ...
        function HapusData(id){
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.jenis_pembayaran.hapusdata') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function HapusTerpilih(){
            if (confirm('  @lang('global.app_confirm')  ')) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{ route('admin.master.jenis_pembayaran.hapusdipilih') }}',
                    data: {
                        _token: _token,
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.jenis_pembayaran.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            if (deskripsi.value.trim() == "") {
                alert("Nama Jenis Pembayaran belum diisi");
                deskripsi.focus();
                return;
            }
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.jenis_pembayaran.store') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
