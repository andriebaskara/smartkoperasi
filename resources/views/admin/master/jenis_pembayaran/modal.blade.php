        ...
        <div class="modal-dialog  modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="modal-title">Jenis Pembayaran</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12 form-group" id='nama_role'>
                        ...
                        <input type="text" class="form-control" id='deskripsi' name='deskripsi' placeholder='Jenis Pembayaran', maxlength=30>
                    </div>
