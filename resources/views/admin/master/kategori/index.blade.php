...
@section('js') 
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Kategori");
            $('#pesan').html("");
            $('#deskripsi').val("");
        ...
        function HapusData(id){
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.kategori.hapusdata') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function HapusTerpilih(){
            if (confirm('  @lang('global.app_confirm')  ')) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{ route('admin.master.kategori.hapusdipilih') }}',
                    data: {
                        _token: _token,
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.kategori.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
