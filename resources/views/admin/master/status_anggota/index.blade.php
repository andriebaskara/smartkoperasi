...
@section('title', 'Master Status Anggota')
...
@section('content')
    ...
    @include('admin.master.status_anggota.modal')
@stop
...
@section('js') 
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Status Anggota");
            $('#pesan').html("");
            $('#deskripsi').val("");
        ...
        function EditData(id, deskripsi, warna){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Status Anggota");
        ...
        function HapusData(id){
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_anggota.hapusdata') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function HapusTerpilih(){
            if (confirm('  @lang('global.app_confirm')  ')) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{ route('admin.master.status_anggota.hapusdipilih') }}',
                    data: {
                        _token: _token,
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_anggota.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            if (deskripsi.value.trim() == "") {
                alert("Nama Status Anggota belum diisi");
                deskripsi.focus();
                return;
            }
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_anggota.store') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
