      ...
      <div class="modal-dialog  modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="modal-title">Status Outlet</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group" id='nama_role'>
                        <p><b>Status Outlet</b></p>
                        <input type="text" class="form-control" id='deskripsi' name='deskripsi' placeholder='Status Outlet', maxlength=30>
                    </div>
