...
@section('title', 'Master Status Pengajuan')

@section('content_header')
    Master Status Pengajuan
@stop
...
@section('content')
    ...
    @include('admin.master.status_pengajuan.modal')
@stop
...
@section('js') 
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Status Pengajuan");
            $('#pesan').html("");
            $('#deskripsi').val("");
            $('#level').val("");
        ...
        function EditData(id, deskripsi, level){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Status Pengajuan");
        ...
        function HapusData(id){
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_pengajuan.hapusdata') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function HapusTerpilih(){
            if (confirm('  @lang('global.app_confirm')  ')) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{ route('admin.master.status_pengajuan.hapusdipilih') }}',
                    data: {
                        _token: _token,
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_pengajuan.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            if (deskripsi.value.trim() == "") {
                alert("Nama Status Pengajuan belum diisi");
                deskripsi.focus();
                return;
            }
            var level = document.getElementById("level");
            if (level.value.trim() == "") {
                alert("Level Pengajuan belum diisi");
                level.focus();
                return;
            }
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_pengajuan.store') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
