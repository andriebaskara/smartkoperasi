...
@section('title', 'Master Status Produk')

@section('content_header')
    Master Status Produk
@stop
...
@section('content')
    ...
    @include('admin.master.status_produk.modal')
@stop
...
@section('js') 
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Status Produk");
            $('#pesan').html("");
            $('#deskripsi').val("");
        ...
        function EditData(id, deskripsi, warna){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Status Produk");
        ...
        function HapusData(id){
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_produk.hapusdata') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function HapusTerpilih(){
            if (confirm('  @lang('global.app_confirm')  ')) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{ route('admin.master.status_produk.hapusdipilih') }}',
                    data: {
                        _token: _token,
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_produk.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            if (deskripsi.value.trim() == "") {
                alert("Nama Status Produk belum diisi");
                deskripsi.focus();
                return;
            }
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status_produk.store') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
