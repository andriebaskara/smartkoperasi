...
@section('title', 'Master Tipe Iuran')
...
@section('content')
    ...
    @include('admin.master.tipe_iuran.modal')
@stop
...
@section('js') 
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Tipe Iuran");
            $('#pesan').html("");
            $('#deskripsi').val("");
        ...
        function EditData(id, deskripsi){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Tipe Iuran");
        ...
        function HapusData(id){
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.tipe_iuran.hapusdata') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function HapusTerpilih(){
            if (confirm('  @lang('global.app_confirm')  ')) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{ route('admin.master.tipe_iuran.hapusdipilih') }}',
                    data: {
                        _token: _token,
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.tipe_iuran.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            if (deskripsi.value.trim() == "") {
                alert("Nama tipe_iuran belum diisi");
                deskripsi.focus();
                return;
            }
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.tipe_iuran.store') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
