            ...
            <div class="col-md-9">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="password_konfirmasi" class="col-sm-4 col-form-label">Password Konfirmasi</label>
                            <div class="col-sm-8">
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-sm btn-danger" onclick="SimpanGantiPassword()" id='btnSimpanGantiPassword'>Ganti Password</button>
                    </div>
